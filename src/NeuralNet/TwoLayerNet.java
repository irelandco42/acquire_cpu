...
public class TwoLayerNet {
    ...
    public TwoLayerNet(NeuronLayer layer1, NeuronLayer layer2) {
        this(layer1, layer2, 0.1);
    }

    public TwoLayerNet(NeuronLayer layer1, NeuronLayer layer2, double learningRate) {
        this.layer1 = layer1;
        this.layer2 = layer2;
    ...
    public void train(double[][] inputs, double[][] outputs, int numberOfTrainingIterations) {
        for (int i = 0; i < numberOfTrainingIterations; ++i) {
            ...
            if(i % 10000 == 0){
                ...
                think(new double[][] {{0, 1, 0, 0}});

                // then
                System.out.println("Prediction on data " + getOutput()[0][0]);
            }
